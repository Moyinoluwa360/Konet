...
`,_U=t=>({user:t.userState.user}),vU=t=>({signIn:()=>t(iU())}),wU=Ks(_U,vU)(uU),EU=t=>A.jsx(TU,{children:A.jsxs(IU,{children:[A.jsx(SU,{children:A.jsx("a",{href:"/home",children:A.jsx("img",{src:"/assets/konet.jpg",alt:""})})}),A.jsxs(PU,{children:[A.jsx("div",{children:A.jsx("input",{type:"text",placeholder:"Search"})}),A.jsx(RU,{children:A.jsx("img",{src:"/assets/search-icon.svg",alt:""})})]}),A.jsx(AU,{children:A.jsxs(CU,{children:[A.jsx(Yi,{className:"active",children:A.jsxs("a",{children:[A.jsx("img",{src:"/assets/nav-home.svg",alt:""}),A.jsx("span",{children:"Home"})]})}),A.jsx(Yi,{children:A.jsxs("a",{children:[A.jsx("img",{src:"/assets/nav-network.svg",alt:""}),A.jsx("span",{children:"My Network"})]})}),A.jsx(Yi,{children:A.jsxs("a",{children:[A.jsx("img",{src:"/assets/nav-jobs.svg",alt:""}),A.jsx("span",{children:"Jobs"})]})}),A.jsx(Yi,{children:A.jsxs("a",{children:[A.jsx("img",{src:"/assets/nav-messaging.svg",alt:""}),A.jsx("span",{children:"Messaging"})]})}),A.jsx(Yi,{children:A.jsxs("a",{children:[A.jsx("img",{src:"/assets/nav-notifications.svg",alt:""}),A.jsx("span",{children:"Notifications"})]})}),A.jsxs(gS,{children:[A.jsxs("a",{children:[t.user&&t.user.photoURL?A.jsx("img",{src:t.user.photoURL,alt:""}):A.jsx("img",{src:"/assets/user.svg",alt:""}),A.jsxs("span",{children:["Me",A.jsx("img",{src:"/assets/down-icon.svg",alt:""})]})]}),A.jsx(mS,{onClick:t.signOut,children:A.jsx("a",{children:"Sign Out"})})]}),A.jsx(xU,{children:A.jsxs("a",{children:[A.jsx("img",{src:"/assets/nav-work.svg",alt:""}),A.jsxs("span",{children:["Work",A.jsx("img",{src:"/assets/down-icon.svg",alt:""})]})]})})]})})]})}),TU=q.div`
  background-color: white;
...
`,kU=t=>({user:t.userState.user}),bU=t=>({signOut:()=>t(oU())}),OU=Ks(kU,bU)(EU),NU=t=>A.jsxs(DU,{children:[A.jsxs(yS,{children:[A.jsxs(LU,{children:[A.jsx(MU,{}),A.jsxs("a",{children:[A.jsx(VU,{}),A.jsxs(UU,{children:["Welcome, !",t.user?t.user.displayName:"there"]})]}),A.jsx("a",{children:A.jsx(FU,{children:"Add a photo"})})]}),A.jsx(jU,{children:A.jsxs("a",{children:[A.jsxs("div",{children:[A.jsx("span",{children:"Connections"}),A.jsx("span",{children:"Grow your network"})]}),A.jsx("img",{src:"/assets/widget-icon.svg",alt:""})]})}),A.jsx($U,{children:A.jsxs("span",{children:[A.jsx("img",{src:"/assets/item-icon.svg",alt:""}),"My Items"]})})]}),A.jsxs(zU,{children:[A.jsx("a",{children:A.jsx("span",{children:"Groups"})}),A.jsx("a",{children:A.jsxs("span",{children:["Events",A.jsx("img",{src:"/assets/plus-icon.svg",alt:""})]})}),A.jsx("a",{children:A.jsx("span",{children:"Follow Hashtags"})}),A.jsx("a",{children:A.jsx("span",{children:"Discover more"})})]})]}),DU=q.div`
  grid-area: leftside;
`,yS=q.div`
  text-align: center;
  overflow: hidden;
...
`,Ej=t=>({user:t.userState.user}),Tj=t=>({postArticleAPI:e=>{t(aU(e))}}),Ij=Ks(Ej,Tj)(uj),Sj=t=>{const[e,n]=z.useState("close");z.useEffect(()=>{t.getArticles()},[]);const r=i=>{if(i.preventDefault(),i.target===i.currentTarget)switch(e){case"open":n("close");break;case"close":n("open");break;default:n("close");break}};return A.jsx(A.Fragment,{children:t.articles.length===0?A.jsx("p",{children:"There are no Articles"}):A.jsxs(Pj,{children:[A.jsxs(Rj,{children:[A.jsxs("div",{children:[t.user&&t.user.photoURL?A.jsx("img",{src:t.user.photoURL,alt:""}):A.jsx("img",{src:"/assets/user.svg",alt:""}),A.jsx("button",{onClick:r,disabled:!!t.loading,children:"Start a post"})]}),A.jsxs("div",{children:[A.jsxs("button",{children:[A.jsx("img",{src:"/assets/picture-icon.png",alt:""}),A.jsx("span",{children:"Photo"})]}),A.jsxs("button",{children:[A.jsx("img",{src:"/assets/video-icon.png",alt:""}),A.jsx("span",{children:"Video"})]}),A.jsxs("button",{children:[A.jsx("img",{src:"/assets/event.png",alt:""}),A.jsx("span",{children:"Event"})]}),A.jsxs("button",{children:[A.jsx("img",{src:"/assets/article-icon.png",alt:""}),A.jsx("span",{children:"Write airticle"})]})]})]}),A.jsxs(Nj,{children:[t.loading&&A.jsx("img",{src:"/assets/infinite-spinner.svg",alt:"",width:"100px",height:"100px"}),t.articles.length>0&&t.articles.map((i,s)=>A.jsxs(Aj,{children:[A.jsxs(Cj,{children:[A.jsxs("a",{children:[A.jsx("img",{src:i.actor.image,alt:""}),A.jsxs("div",{children:[A.jsx("span",{children:i.actor.title}),A.jsx("span",{children:i.actor.description}),A.jsx("span",{children:i.actor.date.toDate().toLocaleDateString()})]})]}),A.jsx("button",{children:A.jsx("b",{children:". . ."})})]}),A.jsx(xj,{children:i.description}),A.jsx(kj,{children:A.jsx("a",{children:!i.SharedImg&&i.video?A.jsx(nP,{width:"100%",url:i.video}):i.sharedImg&&A.jsx("img",{src:i.sharedImg,alt:""})})}),A.jsxs(bj,{children:[A.jsx("li",{children:A.jsxs("button",{children:[A.jsx("img",{src:"/assets/thumb-up.svg",alt:""}),A.jsx("img",{src:"/assets/heart.svg",alt:""}),A.jsx("span",{children:"75"})]})}),A.jsx("li",{children:A.jsx("a",{children:"0 comments"})})]}),A.jsxs(Oj,{children:[A.jsxs("button",{children:[A.jsx("img",{src:"/assets/thumb-up.svg",alt:""}),A.jsx("span",{children:"Like"})]}),A.jsxs("button",{children:[A.jsx("img",{src:"/assets/comment.svg",alt:""}),A.jsx("span",{children:"Comment"})]}),A.jsxs("button",{children:[A.jsx("img",{src:"/assets/share.svg",alt:""}),A.jsx("span",{children:"Share"})]}),A.jsxs("button",{children:[A.jsx("img",{src:"/assets/send.svg",alt:""}),A.jsx("span",{children:"Send"})]})]})]},s))]}),A.jsx(Ij,{showModal:e,handleClick:r})]})})},Pj=q.div`
  grid-area: main;
`,rP=q.div`
    text-align: center;
    overflow: hidden;
...
`,Dj=t=>({loading:t.articleState.loading,user:t.userState.user,articles:t.articleState.articles}),Lj=t=>({getArticles:()=>t(lU())}),Mj=Ks(Dj,Lj)(Sj),Vj=t=>A.jsxs(Uj,{children:[A.jsxs(iP,{children:[A.jsxs(Fj,{children:[A.jsx("h2",{children:"Add to your feed"}),A.jsx("img",{src:"/assets/feed-icon.svg",alt:""})]}),A.jsxs(jj,{children:[A.jsxs("li",{children:[A.jsx("a",{children:A.jsx(S0,{})}),A.jsxs("div",{children:[A.jsx("span",{children:"#Linkedin"}),A.jsx("button",{children:"Follow"})]})]}),A.jsxs("li",{children:[A.jsx("a",{children:A.jsx(S0,{})}),A.jsxs("div",{children:[A.jsx("span",{children:"#Video"}),A.jsx("button",{children:"Follow"})]})]})]}),A.jsxs($j,{children:["View all recommendations",A.jsx("img",{src:"/assets/right-icon.svg",alt:""})]})]}),A.jsx(zj,{children:A.jsx("img",{src:"/assets/ad.jpg"})})]}),Uj=q.div`
  grid-area: rightside;
`,iP=q.div`
  text-align: center;
  overflow: hidden;
